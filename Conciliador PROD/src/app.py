...
def mostrar_tela_inicial():
    ...
    with col1:
        st.image("C:\\Users\\yan.fernandes\\Desktop\\Conciliador PROD\\assets\\logos\\santander.png", width=70)
    with col2:
    ...
    col1, col2 = st.columns([1, 5])
    with col1:
        st.image("C:\\Users\\yan.fernandes\\Desktop\\Conciliador PROD\\assets\\logos\\cielo.png", width=70)
    with col2:
    ...
    col1, col2 = st.columns([1, 5])
    with col1:
        st.image("C:\\Users\\yan.fernandes\\Desktop\\Conciliador PROD\\assets\\logos\\credshop.png", width=70)
    with col2:
    ...
    col1, col2 = st.columns([1, 5])
    with col1:
        st.image("C:\\Users\\yan.fernandes\\Desktop\\Conciliador PROD\\assets\\logos\\pagbank.png", width=70)
    with col2:
